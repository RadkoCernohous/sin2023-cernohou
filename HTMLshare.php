...
<main>
  <div  class="hlavniStrana ">
    <p class="popisStranky"><?php if (isset($_SESSION["descr"])){print($_SESSION["descr"]);} ?> To import this data to Your database, fill-in your credentials in the form below. After a succesfull import, you will be redirectet to your Langlet account.</p>
