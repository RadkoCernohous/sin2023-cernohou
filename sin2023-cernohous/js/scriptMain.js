...
class Aplikace {
  ...
  zacitTest(e) {
    ...
    console.log(this.#prihlasenyUzivatel.slovicka[this.#prihlasenyUzivatel.soucasnyJazyk][this.#prihlasenyUzivatel.soucasnaLekce].length)
  ...
  sdiletGenerovatLink(e) {
    ...
    let link = `127.0.0.1/cernohous/sin2023-cernohous/HTMLshare.php?id=${schovanyKontejner2.value}&`;
